namespace CGrep
{
    partial class CMainUI
    {
        ...
        private void InitializeComponent()
        {
			...
			this.uiSearchAndReplace.Size = new System.Drawing.Size(118, 20);
			...
			this.uiMaxFileSize.WordWrap = false;
			this.uiMaxFileSize.TextChanged += new System.EventHandler(this.uiMaxFileSize_TextChanged);
			this.uiMaxFileSize.Enter += new System.EventHandler(this.uTxt_Enter);
			// 
			// uiPattern
			// 
			...
			this.uiPattern.Text = "*.*";
			this.uiPattern.WordWrap = false;
			this.uiPattern.Enter += new System.EventHandler(this.uTxt_Enter);
			// 
			...
			this.uiIncludeSubDirectories.Size = new System.Drawing.Size(148, 20);
			...
			this.uiSearchDirectory.WordWrap = false;
			this.uiSearchDirectory.TextChanged += new System.EventHandler(this.uiSearchDirectory_TextChanged);
			this.uiSearchDirectory.Enter += new System.EventHandler(this.uTxt_Enter);
			// 
			// uiBtnFindInResults
			// 
			...
			this.uiBtnFindInResults.Visible = false;
			...
			this.uiFindFilesList.HideSelection = false;
			...
			this.uiDeleteFileBtn.Visible = false;
